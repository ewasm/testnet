...
1. Run geth with hera and connect to the testnet:
	...
	```sh
	./build/bin/geth --datadir /tmp/ewasm-node/4201/ --etherbase 031159dF845ADe415202e6DA299223cb640B9DB0 --vm.ewasm="/home/ewasm/hera/src/libhera.so,metering=true,fallback=true" --rpc --rpcapi "web3,net,eth,debug" --rpcvhosts="*" --rpcaddr "0.0.0.0" --rpccorsdomain "*" --vmodule "miner=12,rpc=12" --mine --miner.threads 1 --nodiscover --networkid 66 
	```
